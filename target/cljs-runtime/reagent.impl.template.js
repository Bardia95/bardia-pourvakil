...
var G__36288 = o;
goog.object.set(G__36288,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__36328__i < G__36328__a.length) {G__36328__a[G__36328__i] = arguments[G__36328__i + 0]; ++G__36328__i;}
  args = new cljs.core.IndexedSeq(G__36328__a,0,null);
} 
...
var args = cljs.core.seq(arglist__36329);
...
var G__36289 = o;
goog.object.set(G__36289,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__36297 = props;
var G__36297__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36297,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36297);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36297__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__36297__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36298 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36298,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36298;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36299){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36300__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__36310_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36310_SHARP_);
}));
} else {
return null;
}
...
var vec__36312 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36312,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36312,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36312,(2),null);
...
var temp__5739__auto___36352 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36352 == null)){
} else {
var key_36353 = temp__5739__auto___36352;
(jsprops.key = key_36353);
}
...
var temp__5739__auto___36358 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36358 == null)){
} else {
var key_36359 = temp__5739__auto___36358;
(jsprops.key = key_36359);
}
...
var G__36316 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36316) : reagent.impl.template.as_element.call(null,G__36316));
} else {
var temp__5739__auto___36377 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___36377 == null)){
} else {
var key_36378 = temp__5739__auto___36377;
(jsprops.key = key_36378);
}
...
var G__36318 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__36318)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__36318)){
return x;
} else {
...
var i__4790__auto___36380 = (0);
while(true){
if((i__4790__auto___36380 < len__4789__auto___36379)){
args__4795__auto__.push((arguments[i__4790__auto___36380]));

var G__36381 = (i__4790__auto___36380 + (1));
i__4790__auto___36380 = G__36381;
continue;
} else {
}
break;
...
var ctx = ({});
var vec__36323 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36323,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36323,(1),null);
...
var G__36326 = (cljs.core.count(argv) - first_child);
switch (G__36326) {
case (0):
