...
if((i < len)){
var k = (ks[i]);
var G__36257 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36258 = (i + (1));
m = G__36257;
i = G__36258;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36196 = c;
var G__36196__$1 = (((G__36196 == null))?null:G__36196.prototype);
if((G__36196__$1 == null)){
return null;
} else {
return G__36196__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36198 = c;
var G__36198__$1 = (((G__36198 == null))?null:G__36198.prototype);
if((G__36198__$1 == null)){
return null;
} else {
return G__36198__$1.render;
}
})() == null)))));
});
...
var G__36209 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36209) : reagent.impl.component.as_element.call(null,G__36209));
};
...
var G__36210 = c;
var G__36210__$1 = (((G__36210 == null))?null:G__36210.constructor);
if((G__36210__$1 == null)){
return null;
} else {
return G__36210__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__36211 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36212 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36212);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36211);
}});
...
var c = this;
var G__36222_36293 = goog.object.get(c,"cljsRatom");
if((G__36222_36293 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36222_36293);
}
...
var renders_36295 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36296 = cljs.core.first(cljs.core.vals(renders_36295));
...
if((cljs.core.count(renders_36295) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36295))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36296)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36296], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36223 = o;
goog.object.set(G__36223,cljs.core.name(k),v);
